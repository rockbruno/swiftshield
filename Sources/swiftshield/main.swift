...
extension Swiftshield {
    struct Obfuscate: ParsableCommand {
        ...
        @Option(name: .shortAndLong, help: "A list of names, separated by a comma, that will definitively be obfuscated.")
        var enforceNames: String?
        ...
        func run() throws {
            ...
            let namesToEnforce = Set((enforceNames ?? "").components(separatedBy: ","))
