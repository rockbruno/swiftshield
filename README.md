...
**Note: I've detected several issues when running the automatic mode in a Swift 5 / Xcode 10.2 environment or any Swift version with Xcode 10's new build system due to recent SourceKit changes. Hold on for a bit if you want to use this in Swift 5 or Swift 4 with the new build system (you can still use Legacy mode).**
