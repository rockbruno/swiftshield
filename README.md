...
Manual mode will obfuscate properties and classes based on a tag of your choice. For example, after running SwiftShield in manual mode and a tag `__s`, the following code:
```swift
